# This is taken from llama-cpp 12 Mar 2024, for conversion of models to GGUF to run on llama-cpp.
# It can also be used for converting modified tokenizer.json to tokenizer.model. See https://github.com/ggerganov/llama.cpp/issues/2443
