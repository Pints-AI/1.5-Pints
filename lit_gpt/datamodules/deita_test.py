...
from lit_gpt.datamodules.deita import format_dataset

MOCK_DATA = []

with open(
    './lit_gpt/datamodules/deita_test.jsonl', 'r', encoding='utf-8'
) as jsonl_file:
    for line in jsonl_file:
        MOCK_DATA.append(loads(line))


def test_deita_format_dataset_multiturn():
